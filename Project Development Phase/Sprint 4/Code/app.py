...
def getDonorsList(send_email, blood_group):
  ...
  if donors:
    while donors:
      ...
      if send_email:
        sendMail(donors['EMAIL'], 'URGENT!!! Plasma Donation needed', '{} has requested for plasma of {} blood group. You can contact them at {} and {}'.format(donors['NAME'],donors['BLOOD_GROUP'],donors['PHONE'], donors['EMAIL']))
      donors = ibm_db.fetch_assoc(stmt)
  return donorList
